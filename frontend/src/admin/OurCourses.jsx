...
const navigate=useNavigate();
    ...
    const token=admin.token;
      if(!token){
        toast.error("plz login to admin")
      }
...
try{
const response=await axios.delete( `http://localhost:3001/api/v1/course/delete${id}`,
    {
        headers:{
...
setCourses(updatedCourses);
        ...
        console.log("Error in deleteing course",error);
        toast.error(error.messsage.data.errors|| "Error in deleteing course")
    }
}
